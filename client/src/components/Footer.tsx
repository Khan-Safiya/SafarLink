...
export default function Footer() {
    return (
        <footer className="bg-[#07503E] text-white py-16 border-t border-white/10 dark:border-border">
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12">
                <div className="col-span-1 md:col-span-2">
                    <div className="flex items-center gap-2 mb-6">
                        <Leaf className="w-6 h-6 text-[#2FCE65]" />
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="w-10 h-10 rounded-full bg-white/10 hover:bg-[#2FCE65] transition cursor-pointer flex items-center justify-center">
