...
export default function RouteDetails() {
    ...
    return (
        <div className={`relative min-h-screen font-sans transition-colors duration-500 flex flex-col overflow-x-hidden ${isWomenOnly ? 'bg-gradient-to-br from-pink-50 to-pink-100 dark:from-[#831843] dark:to-pink-950' : 'bg-gradient-to-br from-white via-[#f0f9ff]/80 to-[#e0f2fe]/80 dark:from-[#0a0a0a] dark:to-[#0f172a]'}`}>
            <Navbar
            ...
            <main className="flex-grow p-4 md:p-8 max-w-3xl mx-auto w-full space-y-8 z-10 relative mt-4">
                ...
                {/* Header Summary Card */}
                <Card className="border border-blue-100/60 shadow-xl shadow-blue-900/5 bg-white/90 backdrop-blur-sm dark:bg-card overflow-hidden">
                    <div className={`p-6 bg-gradient-to-br ${route.type === 'fastest' ? 'from-blue-500/10 to-transparent' :
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                            <div className="bg-white/70 dark:bg-black/30 p-3 rounded-xl backdrop-blur-sm border border-blue-50 dark:border-white/5">
            ...
            {/* Fixed Action Footer */}
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 dark:bg-black/80 backdrop-blur-md border-t border-blue-100/60 dark:border-white/10 z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
                <div className="max-w-3xl mx-auto flex gap-3 items-center">
                    ...
                    <Button
                        ...
                        variant="outline"
                        className="px-5 h-12 font-bold border-[#635BFF] text-[#635BFF] hover:bg-[#635BFF]/10 hover:text-[#635BFF] transition-colors flex gap-2"
                    >
